...
const ResetPasswordSuccessNotice = ({navigation} : MainTabNavigationProps) => {
  return (
    <ImageBackground
      ...
      <Text style={styles.desc}>Password reset succesful</Text>
...
export default ResetPasswordSuccessNotice;
